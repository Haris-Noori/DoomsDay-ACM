...
<head>
    <title>Add Operator | Admin</title>
    ...
    <?php include "admin_header.php" ?>
        <!-- Admin Dashboard Code Start-->
            ...
            <div class="container-fluid">
                <h1 class="mt-4">Add New Operator</h1>
                
                <form class="myform" action="add_operator_try.php" method="POST">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            <label for="inputPassword4">Operator Password</label>
                            <input type="text" class="form-control" id="inputPassword4" placeholder="123" name="op_pass"  required>
                        </div>
                    </div>
